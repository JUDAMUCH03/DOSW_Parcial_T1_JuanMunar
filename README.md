...
**Descripcion:** El Sistema debe garantizar que al menos el 90% de las peticiones diarias realizadas se resuelvan de manera satisfactoria, verificando el tiempo y cada peticion en AWS S3 Buckets

**UFH-RNF-02: La información de los pedidos se almacena en AWS Mongo Atlas.**  
**Descripción:** El almacenamiento de la informacion de los pedidos debe gestionarse en una base de datos NoSQL (MongoDB Atlas).
